          ...
          <div class="project-card__header">
            ...
            <div class="project-card__actions">
              <a
                ...
                :aria-label="`Open the live ${project.name} demo`"
...
<style scoped>
  ...
  .project-card__title-group {
    ...
    align-items: center;
    gap: 0.75rem;
    /* Lets a long title wrap instead of pushing the action buttons out. */
    min-width: 0;
  }
  ...
  /* Live demo link — tinted so it reads as the primary call to action. */
